...
const timelineData = [
  {
    ...
    techStack: "Python, EDA, Regression, Power BI",
    summaryPoints:
      "Performed data analysis using Python, built visual dashboards with Power BI, and supported business decisions with insights.",
  },
  {
    timelineType: "work",
  ...
  },
  {
    ...
    summaryPoints: "Current CGPA: 8.6",
  },
  {
    timelineType: "education",
    title: "HSC",
    name: "Geetamata Junior College",
    dateRange: "2020 – 2022",
    summaryPoints: "Score: 77%",
  },
  {
    timelineType: "education",
    title: "SSC",
    name: "Nirmal Bethany High School & Jr. College",
    dateRange: "2019 – 2020",
    summaryPoints: "Score: 81%",
  },
];
